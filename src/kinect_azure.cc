                               ...
                               while (is_listening)
                               {
                                 ...
                                 if (g_customDeviceConfig.include_depth_to_color)
                                 {
                                           ...
                                           &depth_to_color_image) == K4A_RESULT_SUCCEEDED)
                                   {
                                     ...
                                     if (
                                         depth_image != NULL && k4a_transformation_depth_image_to_color_camera(transformer, depth_image, depth_to_color_image) == K4A_RESULT_SUCCEEDED)
                                     {
                                 ...
                                 if (g_customDeviceConfig.include_color_to_depth)
                                 {
                                   ...
                                   {
                                     if (depth_image != NULL && k4a_transformation_color_image_to_depth_camera(transformer, depth_image, color_image, color_to_depth_image) == K4A_RESULT_SUCCEEDED)
                                     {
                                   ...
                                   if (pop_frame_result == K4A_WAIT_RESULT_SUCCEEDED)
                                   {
                                     ...
                                     if (g_customDeviceConfig.include_body_index_map)
                                     {
                                       ...
                                       if (g_customDeviceConfig.include_depth_to_color)
                                       {
                                         ...
                                         {
                                           if (depth_image != NULL && k4a_transformation_depth_image_to_color_camera_custom(transformer, depth_image, body_index_map_image, depth_to_color_image, body_index_map_color_image, K4A_TRANSFORMATION_INTERPOLATION_TYPE_NEAREST, K4ABT_BODY_INDEX_MAP_BACKGROUND) == K4A_RESULT_SUCCEEDED)
                                           {
